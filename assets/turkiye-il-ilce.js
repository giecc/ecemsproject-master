...
const turkiyeAdres = {
  ...
  "Kocaeli": {"Başiskele":[],"Çayırova":[],"Darıca":[],"Derince":[],"Dilovası":[],"Gebze":[],"Gölcük":[],"İzmit":[],"Kandıra":[],"Karamürsel":[],"Kartepe":[],"Körfez":[],"Tütünçiftlik":[]},
  ...
  "Zonguldak": {"Alaplı":[],"Çaycuma":[],"Devrek":[],"Ereğli":[],"Gökçebey":[],"Kilimli":[],"Kozlu":[],"Merkez":[],"Muslu":[]}
};